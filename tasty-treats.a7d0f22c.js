...
})({"bvovD":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "be0a8283a7d0f22c";
"use strict";
...
},{}],"galgN":[function(require,module,exports,__globalThis) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"iooIk":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function startPagination(page, perPage, totalPages, callback) {
    const options = {
        ...
        template: {
            ...
            moveButton: '<a href="#" class="tui-page-btn tui-{{type}} move-button"><span class="tui-ico-{{type}}">{{type}}</span></a>',
            disabledMoveButton: '<span class="tui-page-btn tui-is-disabled tui-{{type}} prev-button"><span class="tui-ico-{{type}}">{{type}}</span></span>',
            moreButton: '<a href="#" class="tui-page-btn tui-{{type}}-is-ellip more-button"><span class="tui-ico-ellip">...</span></a>'
        }
    };
    const pagination = new (0, _tuiPaginationDefault.default)('pagination', options);
    pagination.on('afterMove', ({ page })=>{
        callback(page);
    });
}
exports.default = startPagination;
...
},{}],"82Il4":[function() {},{}],"5mYSJ":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
// Puanlamada kullanılan yıldızların renkleri - Colors of stars in rating
parcelHelpers.export(exports, "measureRating", ()=>measureRating);
// Puanlamada kullanılan yıldızlar - Stars for rating
parcelHelpers.export(exports, "ratingScale", ()=>ratingScale);
var _iconsSvg = require("../../img/icons.svg"); // DOM'da kullanılmak üzere icon dosya yolunu çağırdık.
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
function measureRating(position, pating) {
    if (position <= pating) return 'rate-item-active';
    return 'rate-item';
}
...
function checkOnFavs(id) {
    ...
    if (storage && data.find((recipe)=>recipe.id === id)) return 'active';
    return '';
}
    ...
    return `<ul class='rate-list'>
             <li class=${measureRating(1, rating)}>
              <svg class='star-icon' width='18' height='18'>
                <use href='${0, _iconsSvgDefault.default}#star'></use>
              </svg>
            </li>
                  ...
                  <div class='inter-box'>
                    ...
                    name='favorite'>
                      <svg class='heart-icon' width='22' height='22'>
                          <use href='${0, _iconsSvgDefault.default}#heart'></use>
                        </svg>
                    </button> 
...
},{"../../img/icons.svg":"d6UCS","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"d6UCS":[function() {},{}],"eeubU":[function(require,module,exports,__globalThis) {

},{}],"82STE":[function(require,module,exports,__globalThis) {

},{}],"9AkT3":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
// Açılır pencere - Modal
parcelHelpers.export(exports, "OpenModal", ()=>OpenModal);
// Favorilere ekleme - Add to favorites
parcelHelpers.export(exports, "AddToFav", ()=>AddToFav);
var _api = require("../services/API");
var _renders = require("../renders/renders");
...
function OpenModal(currentBtn) {
    ...
    const data = JSON.parse(storage);
    if (storage) {
        if (data.find((el)=>el.id === currentBtn.dataset.id)) saveRecipeBtn.textContent = 'Remove favorite';
        else saveRecipeBtn.textContent = 'Add to favorite';
    }
...
function GiveRate(e) {
    ...
    if (target) {
        ...
        [
            ...e.currentTarget.children
        ].forEach((el, i)=>i <= rate - 1 ? el.classList.add('is-rated') : el.classList.remove('is-rated'));
...
async function SubmitRate(e) {
    ...
    try {
        await (0, _api.patchRating)(id, data);
        (0, _notiflixDefault.default).Notify.success("Tarifimizi be\u011Fendi\u011Finiz i\xe7in te\u015Fekk\xfcr ederim. \nThank you for appreciating the recipe.");
    } catch (error) {
        (0, _notiflixDefault.default).Notify.failure(error.response.data.message || "Puanlama s\u0131ras\u0131nda hata! \nRating has not been submited...");
    }
    CloseModal();
}
...
function restoreForm() {
    [
        ...modalRateList.children
    ].forEach((el)=>el.classList.remove('is-rated'));
...
async function genereteRecipe(id) {
    try {
        const recipe = await (0, _api.fetchRecipes)(id);
...
function CreateMarkup(data) {
    ...
    let tagslist = '';
    if (!tags[0]) ;
    else for(let k = 0; k < tags.length; k++)tagslist += `<li class="recipe-tag">#${tags[k]}</li>`;
    let ingrList = '';
    for(let i = 0; i < ingr.length; i++)ingrList += `<li class="recipe-ingridient">${ingr[i].name} <span class="recipe-ps">${ingr[i].measure}</span></li>`;
    const fixRating = data.rating > 5 ? Number(5).toFixed(1) : data.rating.toFixed(1);
    ...
    <div class="recipe-title">
      ...
      <div class="rating-part">
        <p class='rate'>${fixRating}</p>
      ${(0, _renders.ratingScale)(fixRating)}
...
function addScrollbarText() {
    ...
    const scrollbar = (0, _smoothScrollbarDefault.default).init(scrollbarBox, {
        alwaysShowTracks: true
    });
    const scrollbarIngs = document.querySelector('.ingridients');
    const scrollbarSec = (0, _smoothScrollbarDefault.default).init(scrollbarIngs, {
        alwaysShowTracks: true
    });
}
...
function checkSrc(url, description) {
    if (url.endsWith('.jpg')) return `<img class="modal-img" src="${url}" alt="${description}">`;
    else return `<iframe
      class="recipe-frame"
      src="${url}"
      frameborder="0"
    ...
    if (storage) {
        if (data.find((el)=>el.id === currentRec.id)) {
            localStorage.setItem('favorites', JSON.stringify([
                ...data.filter((el)=>el.id !== currentRec.id)
            ]));
...
},{"../renders/renders":"5mYSJ","smooth-scrollbar":"lwF0H","notiflix":"hpqv0","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","../services/API":"galgN"}],"lwF0H":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"jNLGZ":[function(require,module,exports,__globalThis) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"hpqv0":[function(require,module,exports,__globalThis) {
var global = arguments[3];
...
},{}],"h96Oj":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _renders = require("../renders/renders");
var _rendersDefault = parcelHelpers.interopDefault(_renders);
var _pagination = require("./pagination");
var _paginationDefault = parcelHelpers.interopDefault(_pagination);
var _modalRecipes = require("./modal-recipes");
var _notiflix = require("notiflix");
var _notiflixDefault = parcelHelpers.interopDefault(_notiflix);
const refs = {
...
const onFavoritesReload = ()=>{
    ...
    if (data.length) refs.favoriteCategoriesList.innerHTML = `${allCatBtn}${categoryMarkup}`;
    else refs.allBtn.style.display = 'none';
    generateStorageList();
};
const generateStorageList = (pageSet = 1)=>{
    ...
    if (data.length) {
        ...
        if (totalPages > 1) {
            ...
            (0, _paginationDefault.default)(pageSet, perPage, totalPages, generateStorageList);
        } else refs.paginationBox.style.display = 'none';
        let filteredData;
        if (currentCategory === '') filteredData = data;
        else filteredData = data.filter((recipe)=>recipe.category === currentCategory);
        const listMarkup = filteredData.reduce((markup, { title, description, preview, rating, id, category })=>markup + (0, _rendersDefault.default)(title, description, preview, rating, id, category), '');
        ...
        seeRecipeButtons.forEach((seeRecipeButton)=>{
            seeRecipeButton.addEventListener('click', ()=>{
                (0, _modalRecipes.OpenModal)(seeRecipeButton);
            });
        });
    ...
    if (data.length === 0) {
        ...
        refs.favoriteCategoriesList.innerHTML = '';
        refs.allBtn.style.display = 'none';
    } else refs.warning.classList.add('is-hidden');
};
const generateCategoryList = ()=>{
    const storage = localStorage.getItem('favorites');
    const data = JSON.parse(storage) || [];
    if (data.length) return data.flatMap((recipe)=>recipe.category).filter((category, index, array)=>array.indexOf(category) === index).reduce((categoryMarkup, category)=>categoryMarkup + renderCategory(category), '');
    return '';
};
...
const setActiveClass = (targetButton)=>{
    ...
    categoryButtons.forEach((button)=>{
        if (button === targetButton) button.classList.add('onActive');
        else button.classList.remove('onActive');
    });
...
const handleFavoriteButtonClick = (button)=>{
    ...
    if (recipeIndex !== -1) {
        ...
        const otherRecipesInCategory = remainingData.some((recipe)=>recipe.category === removedRecipeCategory);
        if (!otherRecipesInCategory) {
            const recipeCards = document.querySelectorAll('.item');
            recipeCards.forEach((card)=>{
                if (card.dataset.category === removedRecipeCategory) card.remove();
            });
            const categoryButtons = refs.favoriteCategoriesList.querySelectorAll('.button-fav');
            categoryButtons.forEach((categoryButton)=>{
                if (categoryButton.textContent === removedRecipeCategory) categoryButton.remove();
            });
        }
    }
    const remainingData = JSON.parse(localStorage.getItem('favorites')) || [];
...
},{"../renders/renders":"5mYSJ","./pagination":"iooIk","./modal-recipes":"9AkT3","notiflix":"hpqv0","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["bvovD"], null, "parcelRequire78be", {})

//# sourceMappingURL=tasty-treats.a7d0f22c.js.map
